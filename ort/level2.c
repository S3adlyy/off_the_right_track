...
void game_level2(SDL_Surface *ecran, int *page){
	...
	loadSettings(&volumeMusic, &volumeSfx);
        init_music(level2theme, "game/renaissancelvl2.wav");
	...
	dash_sfx= init_chunk("game/dash_sfx.wav");
        ...
        //init chapter intro
        init_image(&intro_img_spritesheet, "game/intro_lvl2_spritesheet.png", SCREEN_W-984, SCREEN_H*0.27);
	...
	//init objectives
	init_objective(&obj[0], "Collect Pens & Books" , 40, 0.3*SCREEN_H);
	init_objective(&obj[1], "Eliminate Enemies" , 3, 0.35*SCREEN_H);
	...
	init_image(&bg, "level2bg.png",0,0);
	init_image(&bgmask, "level2bgmask.png", 0, 0);
	init_minimap(&m, 620, 110, (SDL_Rect){100, 800}, "bglvl2minimap.png");
	...
	init_doc(&documents.T[0], "documents/renaisassy1.png", 1,"documents/renaisassy1_voice.wav");
	init_doc(&documents.T[1], "documents/renaisassy2.png", 2,"documents/renaisassy2_voice.wav");
	init_doc(&documents.T[2], "documents/renaisassy3.png", 3,"documents/renaisassy3_voice.wav");
	init_doc(&documents.T[3], "documents/renaisassy4.png", 4,"documents/renaisassy4_voice.wav");
	init_doc(&documents.T[4], "documents/renaisassy5.png", 5,"documents/renaisassy5_voice.wav");
